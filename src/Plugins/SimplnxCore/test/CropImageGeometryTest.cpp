...
TEST_CASE("SimplnxCore::CropImageGeometry: real OOC stores preserve cropped values", "[SimplnxCore][CropImageGeometryFilter][CropScratch][OOC]")
{
  ...
  SIMPLNX_RESULT_REQUIRE_VALID(sourceGeometryAction.apply(dataStructure, IDataAction::Mode::Execute));
  SIMPLNX_RESULT_REQUIRE_VALID(destinationGeometryAction.apply(dataStructure, IDataAction::Mode::Execute));
  ...
  SIMPLNX_RESULT_REQUIRE_VALID(sourceArrayAction.apply(dataStructure, IDataAction::Mode::Execute));
  SIMPLNX_RESULT_REQUIRE_VALID(destinationArrayAction.apply(dataStructure, IDataAction::Mode::Execute));
  ...
  SIMPLNX_RESULT_REQUIRE_VALID(sourceArray.getDataStoreRef().copyFromBuffer(0, nonstd::span<const int32>(sourceValues.data(), sourceValues.size())));
  ...
  SIMPLNX_RESULT_REQUIRE_VALID(destinationArray.getDataStoreRef().copyIntoBuffer(0, nonstd::span<int32>(actualValues.data(), actualValues.size())));
