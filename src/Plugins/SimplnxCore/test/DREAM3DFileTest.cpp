...
/**
 * @brief Returns the primary DREAM3D round-trip file path.
...
/**
 * @brief Creates nested groups, an AttributeMatrix, and an initialized int8 array.
...
TEST_CASE("DREAM3DFileTest:DREAM3D File IO Test", "[WriteDREAM3DFilter]")
{
  ...
  // Write the pipeline and DataStructure to the primary test file.
  {
  ...
  // Read the same file and validate both stored sections.
  {
    ...
    // The DataStructure must retain its nested groups and array values.
