...
TEST_CASE("ImageProcessing::SignedMaurerDistanceMapImageFilter: preflight rejects non-scalar and tuple mismatch", "[ImageProcessing][SignedMaurerDistanceMapImageFilter]")
{
  ...
  SECTION("non-scalar")
  {
    ...
    auto store = DataStoreUtilities::CreateDataStore<int32>(ds, path, {1, 6, 6}, {3}, IDataAction::Mode::Execute);
  ...
  SECTION("tuple mismatch")
  {
    ...
    auto store = DataStoreUtilities::CreateDataStore<int32>(ds, path, {35}, {1}, IDataAction::Mode::Execute);
